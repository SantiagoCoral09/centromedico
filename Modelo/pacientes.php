...
class Paciente
{
	...
	public function actualizarPaciente($idPaciente)
	{	
		$this->Conexion=Conectarse();
		$sql="update pacientes set pacIdentificacion='$this->identificacion',pacNombres='$this->nombres',pacApellidos='$this->apellidos',pacFechaNacimiento='$this->fechaNacimiento',pacSexo='$this->sexo' where idPaciente = '$idPaciente'";
		$resultado=$this->Conexion->query($sql);
		$this->Conexion->close();
		return $resultado;	
	}
