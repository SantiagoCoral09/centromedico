...
include './encabezado.php'; ?>
                ...
                <div class="container-fluid">
                    ...
                    <!-- Agregar Usuario -->
                    <div class="container">
                        <h3 class="text-center pt-5">Digite el Nombre del Usuario a Actualizar...</h3>
                        <hr>
                    ...
                    <div class="card shadow mb-4">
                        ...
                        ?>
                                    <tr>
                                        ...
                                        <td> <a href="/centromedico/Vista/editarUsuario.php?idUsuario=<?php echo $registro->idUsuario?>">
