...
<div class="card shadow" style="border-radius: 20px; max-height: 420px; overflow: scroll; margin: 20px 10px 10px 10px;">
  ...
  <div class="card-header bg-gradient-primary">
    <div class="text-center">
      <h1 class="h4 text-light mb-4">Información del Medico Registrado</h1>
    </div>
  </div>
  <div class="container">
    <div class="card-body">
      <div class="form-horizontal">
        ...
        <form class="user" id="form1" name="form1"
          action="/centromedico/Controlador/MedicoValidarActualizar.php?idMedico=<?php echo $registro->idMedico?>"
          method="POST">

          <div class="form-group">
            <label class="col-sm-4 control-label">Identificación</label>
            <input name="identificacion" type="number" id="identificacion"
              value="<?php echo $registro->medIdentificacion?>" placeholder="Digite No de Identificación"
              class="form-control form-control-user col-sm-5" required>
          </div>
          <div class="form-group">
            <label class="col-sm-4 control-label">Nombres</label>
            <input name="nombres" type="text" value="<?php echo $registro->medNombres?>" id="nombres"
              placeholder="Digite sus Nombres" class="form-control form-control-user col-sm-5" required>
          </div>
          <div class="form-group">
            <label class="col-sm-4 control-label">Apellidos</label>
            <input name="apellidos" type="text" value="<?php echo $registro->medApellidos?>" id="apellidos"
          ...
          <div class="form-group">
            ...
            <select class="col-sm-5 form-control input-lg " name="especialidad">
              <option value="Medico General" <?php if($registro->medEspecialidad=='Medico General') echo 'selected';
                ?>>Médico General</option>
              <option value="Pediatra" <?php if($registro->medEspecialidad=='Pediatra') echo 'selected'; ?>>Pediatra
              </option>
              <option value="Dermatologo" <?php if($registro->medEspecialidad=='Dermatologo') echo 'selected';
                ?>>Dermatólogo</option>
            </select>
          </div>
          <div class="form-group">
            <label class="col-sm-4 control-label">Celular</label>
            <input name="telefono" type="number" value="<?php echo $registro->medTelefono?>" id="telefono"
              placeholder="Digite su No de celular" class="form-control form-control-user col-sm-5" required>
          </div>
          <div class="form-group">
            <label class="col-sm-4 control-label">Correo</label>
            <input name="correo" type="email" value="<?php echo $registro->medCorreo?>" id="correo"
              placeholder="Digite su Correo" class="form-control form-control-user col-sm-5" required>
          </div>
