                ...
                <div class="container-fluid">
                    ...
                    <div class="container">
                        ...
                        <div class="form-horizontal">
                            ...
                            action="/centromedico/Controlador/MedicoValidarActualizar.php?idMedico=<?php echo $registro->idMedico?>" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label class="col-sm-4 control-label" >Nombres</label>
                                     <input name="nombres" type="text" value="<?php echo $registro->medNombres?>" id="nombres" placeholder="Digite sus Nombres" class="form-control form-control-user col-sm-5" required>
                                  </div>
                                  <div class="form-group">
                                    <label class="col-sm-4 control-label" >Apellidos</label>
                                     <input name="apellidos" type="text" value="<?php echo $registro->medApellidos?>" id="apellidos" placeholder="Digite sus Apellidos" class="form-control form-control-user col-sm-5" required>
                                  </div>
                                  <div class="form-group">    
                                  ...
                                  <div class="form-group">
                                    <label class="col-sm-4 control-label" >Celular</label>
                                     <input name="telefono" type="number" value="<?php echo $registro->medTelefono?>" id="telefono" placeholder="Digite su No de celular" class="form-control form-control-user col-sm-5" required>
                                  </div>
                                  <div class="form-group">
                                    <label class="col-sm-4 control-label" >Correo</label>
                                     <input name="correo" type="email" value="<?php echo $registro->medCorreo?>" id="correo" placeholder="Digite su Correo" class="form-control form-control-user col-sm-5" required>
                                  </div>
