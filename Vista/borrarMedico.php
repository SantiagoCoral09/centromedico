  ...
  <div class="card shadow"
    ...
    <div class="card-header bg-gradient-primary">
      <div class="text-center">
        <h1 class="h4 text-light mb-4">Información del Médico Registrado</h1>
      </div>
    </div>
    <div class="container">
      <div class="card-body">
        <div class="form-horizontal">
          ...
          <form class="user" id="form1" name="form1"
            action="/centromedico/Controlador/MedicoValidarEliminar.php?idMedico=<?php echo $registro->idMedico?>"
            method="POST">
            ...
            <div class="form-group">
              ...
              <input name="telefono" type="number" value="<?php echo $registro->medTelefono?>" id="telefono"
                placeholder="Digite su No de celular" class="form-control form-control-user col-sm-5" disabled>
            </div>
            <div class="form-group">
              <label class="col-sm-4 control-label">Correo</label>
              <input name="correo" type="email" value="<?php echo $registro->medCorreo?>" id="correo"
                placeholder="Digite su Correo" class="form-control form-control-user col-sm-5" disabled>
            </div>
