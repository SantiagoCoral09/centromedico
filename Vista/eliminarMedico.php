...
?>
                ...
                <div class="container-fluid">
                    ...
                    <!-- Agregar Usuario -->
                    <div class="container">
                        <h3 class="text-center pt-5">Digite el No de Identificacion de medico a Eliminar...</h3>
                        <hr>
                    ...
                    <div class="card shadow mb-4">
                        ...
                        ?>
                                    ...
                                    <td><?php echo $registro->medIdentificacion?></td>
                                        ...
                                        <td align="center">
                                            <a href="/centromedico/Vista/borrarMedico.php?idMedico=<?php echo $registro->idMedico?>" title="Clic para Eliminar Medico">
